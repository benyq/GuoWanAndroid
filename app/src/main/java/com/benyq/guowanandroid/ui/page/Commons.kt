...
@Composable
fun AppTopBar(title: String, onBack: (() -> Unit)? = null, @DrawableRes functionIcon: Int? = null, onFunction: (()->Unit)? = null) {
    Row(
        modifier = Modifier
        ...
        if (functionIcon != null) {
            Icon(painter = painterResource(functionIcon), contentDescription = null,
                modifier = Modifier
                    .size(36.dp)
                    .clickable(onClick = {
                        onFunction?.invoke()
